...
export default function RecoveryTab() {
  ...
  const [daysOverdueTab, setDaysOverdueTab] = useState<string>('all');
  ...
  }, [searchTerm, statusFilter, noticeTypeFilter, daysOverdueTab, recoveryDues]);
      ...
      <Card>
        <div className="p-6">
          <div className="flex flex-col md:flex-row items-end gap-4">
            ...
            {(searchTerm || statusFilter !== 'all' || noticeTypeFilter !== 'all') && (
              <Button
                variant="outline"
                size="sm"
                onClick={() => {
