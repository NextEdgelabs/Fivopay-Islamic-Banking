...
const initialEmployees: Employee[] = [
  ...
  },
  {
    id: "EMP-002", 
    name: "Anita Sharma",
    email: "anita.sharma@fivopay.com",
  ...
  },
  {
    id: "EMP-003",
    name: "Suresh Patel",
    email: "suresh.patel@fivopay.com", 
  ...
  },
  {
    id: "EMP-004",
    name: "Kavita Singh",
    email: "kavita.singh@fivopay.com",
...
export function AppProvider({ children }: { children: ReactNode }) {
  ...
  const [dashboardData, setDashboardData] = useState<DashboardData>({
    ...
    branches: [
      { id: 'BR001', name: 'Main Branch', location: 'Mumbai', status: 'Active', performance: 0.92, targetAchievement: 0.95, totalCustomers: 500, totalTransactions: 10000 },
      { id: 'BR002', name: 'Downtown Branch', location: 'Delhi', status: 'Inactive', performance: 0.85, targetAchievement: 0.80, totalCustomers: 300, totalTransactions: 5000 },
      { id: 'BR003', name: 'Bangalore Branch', location: 'Bangalore', status: 'Active', performance: 0.90, targetAchievement: 0.92, totalCustomers: 400, totalTransactions: 8000 },
    ],
    totalBranches: 3,
    activeBranches: 2,
