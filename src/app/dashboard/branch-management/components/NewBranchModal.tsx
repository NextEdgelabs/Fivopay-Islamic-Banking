    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        <div className="flex justify-between items-center mb-6">
          <h3 className="text-xl font-semibold text-stripe-text">Add New Branch</h3>
          <button
            onClick={handleClose}
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-stripe-text">State</label>
              <input
                type="text"
                required
            ...
            <div>
              <label className="block text-sm font-medium text-stripe-text">City</label>
              <input
                type="text"
                required
                value={formData.city}
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-stripe-text">Phone</label>
              <input
                type="tel"
                required
            ...
            <div>
              <label className="block text-sm font-medium text-stripe-text">Email</label>
              <input
                type="email"
                required
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-stripe-text">Manager Name</label>
              <input
                type="text"
                required
            ...
            <div>
              <label className="block text-sm font-medium text-stripe-text">Manager Phone</label>
              <input
                type="tel"
                required
