  ...
  return (
    <div className="space-y-6">
        ...
        <div className="space-y-4">
          <div>
            ...
            <select
              ...
              onChange={(e) => handleChange('bankingModel', e.target.value as 'standard' | 'conventional')}
            ...
            <p className="mt-1 text-sm text-gray-500">
              {localSettings.bankingModel === 'standard' 
                ? 'compliant banking following regulatory principles'
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-500">Standard banking regulations compliance</p>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input
                type="checkbox"
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            >
              <option value="standard">Standard Banking Terms</option>
      ...
      <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
          ...
          <div className="flex items-center justify-between">
            ...
            <label className="relative inline-flex items-center cursor-pointer">
              <input
                ...
                className="sr-only peer"
                disabled={localSettings.bankingModel === 'standard' && localSettings.complianceFramework.regulatoryCompliance}
              />
        ...
        {localSettings.bankingModel === 'standard' && localSettings.complianceFramework.regulatoryCompliance && (
          <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-md">
            <p className="text-sm text-blue-800">
              <strong>Note:</strong> Interest-based products and conventional loans are disabled when regulatory compliance is enabled in standard banking mode.
            </p>
          </div>
        )}
      </div>
